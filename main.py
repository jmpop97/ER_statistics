...
data_calss=Camera_All("mmrBefore","mmrGainIngame","addSurveillanceCamera","addTelephotoCamera","gameRank","characterNum")
ERDataCleansing(data_calss)
test=FigureType()
test.bar_graph_all(data_calss.dic_cameraGroup_mmr,data_calss.dic_cameraGroup_tier,data_calss.dic_cameraGroup_Rank,data_calss.dic_cameraGroup_LukeMai)
test.show()
# import pprint
