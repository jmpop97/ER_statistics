...
class FigureType:
    ...
    def bar_graph_one(self, db={}, titles="", bar_count=1, bar_num=1, team_color="red", figure_n=2):
        db_list=db.items()
        x,y=zip(*db_list)
        alpha = 0.5  # 1/bar_count
        bar_width = 0.7 / bar_count
    ...
    def bar_graph_all(self, db1={}, db2={}, db3={}, db4={},titles="", bar_count=1, bar_num=1, team_color="red", figure_n=2):
        db1_list=db1.items()
        x1,y1=zip(*db1_list)
        db2_list=db2.items()
        x2,y2=zip(*db2_list)
