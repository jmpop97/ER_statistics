...
def change_txt_to_json():
    game_data = {}
    with open(BASE_DATAS_PATH+TXT_GAME_BASE_DATA_FILE_NAME, "r", encoding="utf-8") as f:
        while True:
            line = f.readline()
...
def update_game_base_data(language="Korean"):
    ...
    with open(BASE_DATAS_PATH+JSON_GAME_BASE_DATA_FILE_NAME, 'w', encoding='UTF-8-sig') as f : 
